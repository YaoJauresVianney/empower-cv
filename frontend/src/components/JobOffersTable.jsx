...
export default function JobOffersTable({ offers = [], totalCount = 0, loading = false, onOfferUpdate, onOfferDelete }) {
        ...
        >
          ...
          <tbody>
            {loading
              ...
              : isEmpty
                ? <EmptyState />
                : offers.map((offer) => <JobOfferRow key={offer.id} offer={offer} onOfferUpdate={onOfferUpdate} onOfferDelete={onOfferDelete} />)
            }
          </tbody>
        </table>
      </div>
